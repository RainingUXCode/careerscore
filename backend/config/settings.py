...
def _load_env_file() -> None:
    """Carrega o .env raiz sem registrar ou expor seus valores."""
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'shared.presentation.exception_handler.api_exception_handler',
    'DEFAULT_THROTTLE_CLASSES': ['rest_framework.throttling.AnonRateThrottle'],
    'DEFAULT_THROTTLE_RATES': {
        'anon': os.environ.get('API_ANON_RATE', '60/hour'),
        'resume_analysis': os.environ.get('RESUME_ANALYSIS_RATE', '10/hour'),
    },
}
